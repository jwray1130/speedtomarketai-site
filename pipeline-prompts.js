...
- LOB DISCIPLINE: the AL table includes ONLY claims whose LOB is Auto Liability, Auto Physical Damage (APD), or a combined Auto Liability / APD designation; every such claim belongs in the AL table and NEVER in the GL table. The GL table includes ONLY General Liability claims. Claims in any other LOB (property, workers compensation, inland marine, cargo, etc.) appear in NEITHER table; note their existence in one sentence of the narrative if the run reports them. Apply this LOB assignment before policy-year banding and use it identically in the HTML tables and the loss_history_structured JSON.
